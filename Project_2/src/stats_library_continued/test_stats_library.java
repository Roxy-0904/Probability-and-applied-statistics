...
public class test_stats_library 
{
	public static void main(String[] args)
	{
		...
		System.out.println("PDF at " + xContinuous + ": " + Stats_libreary_Ch4_5.continuousCD(xContinuous, a, b));
		System.out.println("CDF at " + xContinuous + ": " + Stats_libreary_Ch4_5.continuousCD(xContinuous, a, b));
		System.out.println("Random number: " + Stats_libreary_Ch4_5.ContinuousRandom(a, b));
		System.out.println("\nDiscrete Uniform Distribution:");
		System.out.println("PDF: " + Stats_libreary_Ch4_5.discretePD(n));
		System.out.println("CDF at " + xDiscrete + ": " + Stats_libreary_Ch4_5.discreteCD(xDiscrete, n));
		System.out.println("Random number: " + Stats_libreary_Ch4_5.DiscreteRandom(n));
